...
import info.nightscout.androidaps.plugins.pump.medtronicESP.MedtronicFragmentESP;
import info.nightscout.androidaps.plugins.pump.medtronicESP.services.AbstractMedtronicESPService;
...
public abstract class AbstractMedtronicESPPlugin extends PluginBase implements PumpInterface {
    //protected Logger log = LoggerFactory.getLogger(L.PUMP);
    protected Logger log = LoggerFactory.getLogger("Medtronic");

    AbstractMedtronicESPService sMedtronicService;

    public PumpDescription pumpDescription = new PumpDescription();

    public AbstractMedtronicESPPlugin() {
        super(new PluginDescription()
                .mainType(PluginType.PUMP)
                .fragmentClass(MedtronicFragmentESP.class.getName())
    ...
    public int getPreferencesId() {
        return R.xml.pref_medtronicesp;
    }
    ...
    @Override
    public double getReservoirLevel() { return MedtronicESPPump.getInstance().reservoirRemainingUnits; }

    @Override
    public int getBatteryLevel() { return MedtronicESPPump.getInstance().batteryRemaining; }
    ...
    public double getBaseBasalRate() {
        ...
        if (profile != null) {
            MedtronicESPPump.getInstance().baseBasal = profile.getBasal();
    ...
    public String shortStatus(boolean veryShort) {
        MedtronicESPPump pump = MedtronicESPPump.getInstance(); //TODO implement last connection tracking
        String ret = "";
        /*
