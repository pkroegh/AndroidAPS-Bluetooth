...
public class BluetoothPump {
    private static Logger log = LoggerFactory.getLogger(BluetoothPump.class);

    private static BluetoothPump instance = null;

    public static BluetoothPump getInstance() {
        if (instance == null) instance = new BluetoothPump();
        return instance;
    }
    ...
    public static final String PROFILE_PREFIX = "BPUMP-";
